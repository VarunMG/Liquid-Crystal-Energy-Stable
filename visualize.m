function [newDirector1x, newDirector1y,F] = visualize(Q1,Q2,n,m,xVals,yVals,q,tVals)
...
dt = tVals(2)-tVals(1);
important = [1,floor(m/5),  floor(2*m/5), floor(3*m/5), floor(4*m/5),m];
figure;
for i = 1:6
    subplot(2,3,i);
    re = important(i);
